...
<script type="text/javascript">var islrsharing = true;
    var islrsocialcounter = false;</script>
<script type="text/javascript" src="//share.loginradius.com/Content/js/LoginRadius.js"></script>
<div style="z-index:10001;" class="{$horizontal_sharing|escape:'htmlall':'UTF-8'}"></div>
<div style="z-index:10001;" class="{$vertical_sharing|escape:'htmlall':'UTF-8'}"></div>
<!-- /Block Social Sharing -->
